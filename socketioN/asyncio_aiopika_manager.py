...
from socketioN.asyncio_pubsub_manager import AsyncPubSubManager
...
class AsyncAioPikaManager(AsyncPubSubManager):  # pragma: no cover
    ...
    follows::
        ...
        server = socketioN.Server(client_manager=socketioN.AsyncAioPikaManager(
            url))
    ...
    def __init__(self, url='amqp://guest:guest@localhost:5672//',
                 channel='socketioN', write_only=False, logger=None):
        if aio_pika is None:
