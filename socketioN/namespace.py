...
class Namespace(BaseNamespace):
    ...
    def emit(self, event, data=None, room=None, skip_sid=None, namespace=None,
        ...
        The only difference with the :func:`socketioN.Server.emit` method is
    ...
    def send(self, data, room=None, skip_sid=None, namespace=None,
        ...
        The only difference with the :func:`socketioN.Server.send` method is
        that when the ``namespace`` argument is not given the namespace
        associated with the class is used.
        """
    ...
    def enter_room(self, sid, room, namespace=None):
        ...
        The only difference with the :func:`socketioN.Server.enter_room` method
    ...
    def leave_room(self, sid, room, namespace=None):
        ...
        The only difference with the :func:`socketioN.Server.leave_room` method
        is that when the ``namespace`` argument is not given the namespace
        associated with the class is used.
        """
    ...
    def close_room(self, room, namespace=None):
        ...
        The only difference with the :func:`socketioN.Server.close_room` method
        is that when the ``namespace`` argument is not given the namespace
        associated with the class is used.
        """
    ...
    def rooms(self, sid, namespace=None):
        ...
        The only difference with the :func:`socketioN.Server.rooms` method is
        that when the ``namespace`` argument is not given the namespace
        associated with the class is used.
        """
    ...
    def get_session(self, sid, namespace=None):
        ...
        The only difference with the :func:`socketioN.Server.get_session`
    ...
    def save_session(self, sid, session, namespace=None):
        ...
        The only difference with the :func:`socketioN.Server.save_session`
        method is that when the ``namespace`` argument is not given the
        namespace associated with the class is used.
        """
    ...
    def session(self, sid, namespace=None):
        ...
        The only difference with the :func:`socketioN.Server.session` method is
        that when the ``namespace`` argument is not given the namespace
        associated with the class is used.
        """
    ...
    def disconnect(self, sid, namespace=None):
        ...
        The only difference with the :func:`socketioN.Server.disconnect` method
        is that when the ``namespace`` argument is not given the namespace
        associated with the class is used.
        """
...
class ClientNamespace(BaseNamespace):
    ...
    def emit(self, event, data=None, namespace=None, callback=None):
        ...
        The only difference with the :func:`socketioN.Client.emit` method is
        that when the ``namespace`` argument is not given the namespace
        associated with the class is used.
        """
    ...
    def send(self, data, room=None, skip_sid=None, namespace=None,
        ...
        The only difference with the :func:`socketioN.Client.send` method is
        that when the ``namespace`` argument is not given the namespace
        associated with the class is used.
        """
    ...
    def disconnect(self):
        ...
        The only difference with the :func:`socketioN.Client.disconnect` method
        is that when the ``namespace`` argument is not given the namespace
        associated with the class is used.
        """
